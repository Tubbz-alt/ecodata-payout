...
use ecodata_payout::msg::{StateResponse, EcostateResponse, HandleMsg, InitMsg, QueryMsg};
use ecodata_payout::state::State;
...
fn main() {
    ...
    export_schema(&schema_for!(EcostateResponse), &out_dir);
}
